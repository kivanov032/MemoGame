...
//
//import org.example.game_memo.Controllers.ErrorBoxController;
//import org.example.game_memo.Factories.*;
//
//import java.io.IOException;
//import java.util.List;
//import java.util.Map;
//
//public class GameControllerDemo implements GameObserver{
...
//    public GameLogic gameLogic = null; // Класс для логики игры и хранения игровых карточек
//
//    private Stage currentStage; // Текущая сцена
//    private final ErrorBoxController errorBoxController = new ErrorBoxController(); // Класс для вывода ошибки
//
//    // Элементы UI
...
//            GameControllerDemo controller = loader.getController();
...
//        } catch (IOException e) {
//            e.printStackTrace();
//            errorBoxController.show("Ошибка при переходе в Меню: " + e.getMessage());
//        }
//    }
//
//    // Переход на экран меню
...
//
//            // Инициализация загрузчика
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("frames/statistics.fxml"));
//            Stage stage = new Stage();
//            stage.setScene(new Scene(loader.load()));
...
//        } catch (IOException e) {
//            e.printStackTrace();
//            errorBoxController.show("Ошибка перехода: " + e.getMessage());
//        } catch (Exception e) {
//            e.printStackTrace();
//            errorBoxController.show("Ошибка воспроизведения звука: " + e.getMessage());
//        }
//    }
//
//
...
//        if (cards.isEmpty()){
//            errorBoxController.show("Должна быть выбрана хотя бы одна категория карточек!");
//            return;
//        }
...
//            default: errorBoxController.show("Выберите уровень сложности!");
//        }
//    }
//
//
...
//        } catch (IOException e) {
//            e.printStackTrace();
//            errorBoxController.show("Ошибка при запуске игры: " + e.getMessage());
//        }
//    }
//
//
